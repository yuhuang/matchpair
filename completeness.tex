...
\begin{equation}
k= \Call{max}{\{N_s(p_i)\mid p_i \in \mathit{sender}\}},
\end{equation}
...
\end{equation} 
where $P$ is a set of all the processes in the CTP and $k_j$ is a bound that satisfies equation (5) for process $p_j$, then each process in the CTP is divided into a single section. The bound $k$ that satisfies equation (6) is the \textit{max bound}. 
