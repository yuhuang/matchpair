...
\large
\begin{alltt}
\(r\sb{0}(from \ast, to p\sb{1}, B\sb{0}, w\sb{0})\)
\(w\sb{0}(r\sb{0})\)
\(r\sb{1}(from \ast, to p\sb{1}, B\sb{1}, w\sb{1})\)
\(w\sb{1}(r\sb{1})\)
\(r\sb{2}(from p\sb{2}, to p\sb{1}, B\sb{2}, w\sb{2})\)
\(w\sb{2}(r\sb{2})\)
\(s\sb{5}(from p\sb{1}, to p\sb{2},\ 601)\)
\(r\sb{3}(from \ast, to p\sb{1}, B\sb{3}, w\sb{3})\)
\(w\sb{3}(r\sb{3})\)
\(r\sb{4}(from \ast, to p\sb{1}, B\sb{4}, w\sb{4})\)
\(w\sb{4}(r\sb{4})\)
\end{alltt}
\end{minipage}
\end{lrbox}
...
\large
\begin{alltt}
\(s\sb{0}(from p\sb{2}, to p\sb{1},\ 101)\)
\(s\sb{1}(from p\sb{2}, to p\sb{1},\ 201)\)
\(r\sb{5}(from p\sb{1}, to p\sb{2}, B\sb{5}, w\sb{5})\)
\(w\sb{5}(r\sb{5})\)
\(s\sb{2}(from p\sb{2}, to p\sb{1},\ 301)\)
\end{alltt}
\end{minipage}
\end{lrbox}
...
\large
\begin{alltt}
\(s\sb{3}(from p\sb{3}, to p\sb{1},\ 401)\)
\(s\sb{4}(from p\sb{3}, to p\sb{1},\ 501)\)
\end{alltt}
\end{minipage}
\end{lrbox}
