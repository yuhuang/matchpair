...
This section presents how to generate the match pairs for a CTP. For each process in the CTP that contains a sequence of receives, \algoref{algo:main} is called once. 
